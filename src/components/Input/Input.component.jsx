...
export default function InputComponent ({mask, label, type, id, placeholder, register, error }) {
  ...
  return(
   ...
   { type !== 'textarea' &&
     <Styled.InputContainer>
       <Styled.Input $color={error && 'danger'} type={ showPassword ? 'text' : type } id={ id } placeholder={ placeholder } {...register} mask={mask}/>
       { type === 'password' && 
